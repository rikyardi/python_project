...
class Ui_update_kamar(object):
    def update(self):
        ...
        if c == "ID Kamar":
            ...
            cur.execute("UPDATE kamar SET id_harga = '" + b + "' WHERE id_kamar = '" + a + "' ")
        elif c == "status":
            cur.execute("UPDATE kamar SET status = '" + b + "' WHERE id_kamar ='" + a + "' ")
        db.commit()
    def setupUi(self, update_kamar):
        update_kamar.setObjectName("update_kamar")
        update_kamar.resize(800, 600)
        self.centralwidget = QtWidgets.QWidget(update_kamar)
...
"background-color:#40739e;font-family : century gothic;color:#ffffff;")
        ...
        update_kamar.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(update_kamar)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 800, 21))
        self.menubar.setObjectName("menubar")
        update_kamar.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(update_kamar)
        self.statusbar.setObjectName("statusbar")
        update_kamar.setStatusBar(self.statusbar)

        self.btn_update.clicked.connect(self.update)

        self.retranslateUi(update_kamar)
        QtCore.QMetaObject.connectSlotsByName(update_kamar)

    def retranslateUi(self, update_kamar):
        _translate = QtCore.QCoreApplication.translate
        update_kamar.setWindowTitle(_translate("update_kamar", "MainWindow"))
        self.label.setText(_translate("update_kamar", "HOTEL SUKAMAJU"))
        self.btn_update.setText(_translate("update_kamar", "Update"))
        self.label_11.setText(_translate("update_kamar", "Masukkan ID Kamar yang ingin anda update"))
        self.label_6.setText(_translate("update_kamar", "ID Kamar"))
        self.comboBox.setItemText(0, _translate("update_kamar", "ID Kamar"))
        self.comboBox.setItemText(1, _translate("update_kamar", "kelas kamar"))
        self.comboBox.setItemText(2, _translate("update_kamar", "harga"))
        self.comboBox.setItemText(3, _translate("update_kamar", "status"))
        self.label_12.setText(_translate("update_kamar", "Pilih menu yang ingin anda update"))
        self.label_3.setText(_translate("update_kamar", "Update Kamar"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    update_kamar = QtWidgets.QMainWindow()
    ui = Ui_update_kamar()
    ui.setupUi(update_kamar)
    update_kamar.show()
    sys.exit(app.exec_())
