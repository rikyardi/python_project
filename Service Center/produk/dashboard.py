...
"  box-shadow: 0 9px #999;")
    ...
    def retranslateUi(self, Dashboard):
        ...
        self.btn_operator.setText(_translate("Dashboard", "Operator"))
        ...
        self.actionOperator.setText(_translate("Dashboard", "Operator"))
        self.actionOperator.setStatusTip(_translate("Dashboard", "Open Operator"))
